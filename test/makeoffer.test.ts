...
describe("Make Sell Offer ---->", () => {
    ...
    it('Buy sign ----> ', async function () {
        ...
        const dummy_utxos = [{
            txId: "935f04695543527377432eb02a5aae0e5a7d89946a8c565f97e0b26db520846c",
            outputIndex: 0,
            satoshis: 50000,
            scriptPk: '03ac6d5bda18a62e940ee7e2c332da70968945a453329551001d5c8c6fe281669d',
            addressType: AddressType.P2TR,
            ...
            txId: "935f04695543527377432eb02a5aae0e5a7d89946a8c565f97e0b26db520846d",
            outputIndex: 0,
            satoshis: 50000,
            scriptPk: '03ac6d5bda18a62e940ee7e2c332da70968945a453329551001d5c8c6fe281669d',
            addressType: AddressType.P2TR,
        ...
        const utxos = [{
            txId: "935f04695543527377432eb02a5aae0e5a7d89946a8c565f97e0b26db520846e",
            outputIndex: 0,
            satoshis: 50000,
            scriptPk: '03ac6d5bda18a62e940ee7e2c332da70968945a453329551001d5c8c6fe281669d',
            addressType: AddressType.P2TR,
            ...
            txId: "935f04695543527377432eb02a5aae0e5a7d89946a8c565f97e0b26db520846f",
            outputIndex: 0,
            satoshis: 30000,
            scriptPk: '03ac6d5bda18a62e940ee7e2c332da70968945a453329551001d5c8c6fe281669d',
            addressType: AddressType.P2TR,
